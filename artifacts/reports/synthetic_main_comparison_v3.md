...
| --- | --- | ---: | ---: | ---: |
| `frequency_matching` | `random_search` | `0.597` | `4.565` | `0.000` |
| `frequency_matching` | `genetic_algorithm` | `0.630` | `4.546` | `0.000` |
| `frequency_matching` | `cma_es` | `0.000` | `-` | `0.000` |
| `frequency_matching` | `bayesian_optimization` | `0.636` | `4.990` | `0.000` |
| `feasibility_repair` | `random_search` | `0.481` | `4.324` | `0.000` |
| `feasibility_repair` | `genetic_algorithm` | `0.331` | `4.725` | `0.000` |
| `feasibility_repair` | `cma_es` | `0.000` | `-` | `0.000` |
| `feasibility_repair` | `bayesian_optimization` | `0.429` | `4.500` | `0.000` |
